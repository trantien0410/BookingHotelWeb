...
const RestaurantCategoryBox: React.FC<CategoryBoxProps> = ({
  icon: Icon,
  label,
  selected,
  firstCategory,
  ...
  const handleClick = useCallback(() => {
    ...
    const updatedQuery: any = {
      ...currentQuery,
      restaurantCategory: label,
    };

    if (params?.get("restaurantCategory") === label) {
      delete updatedQuery.restaurantCategory;
    }
...
export default RestaurantCategoryBox;
